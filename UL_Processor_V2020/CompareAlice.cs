...
namespace UL_Processor_V2020
{
    ...
    internal class TimeFrameObjSegments
    {
        ...
        public void processAndReportLenaAndAliceFiles()
        {
            ...
            sw.WriteLine("DATE,SUBJECT,START_ONSET_SEC,END_ONSET_SEC,ALICE_START_ONSET_SEC,ALICE_END_ONSET_SEC,LENA_START_ONSET_SEC,LENA_END_ONSET_SEC,TYPE,HASALICE,HASLENA,ALICEUTTCOUNT,LENA_UTT,LENAUTTSEGMENT,LENACRY");
            ...
            {
                currentDay = date;
                String szDate = Utilities.getDateDashStr(date);
                foreach (String szMapId in dayMappings[date].subjectMappings.Keys)
                {
                    ...
                    foreach (TimeFrameObj s in mergedSegments)
                    {
                        sw.WriteLine(szDate + "," + szMapId + "," + s.timeInSecs + "," + s.timeEndISecs + "," +
                            ...
                            (s.lenaSegment != null ? s.lenaSegment.cryNumber : 0));
                    }
        ...
        public CompareAlice(String paFile, String aFile, Boolean oldMappingFormat, String mapFile)
        {
            ...
            foreach (String szDate in szDates.Trim().Split(','))
            {
                ...
                sw.WriteLine("SUBJECT,TYPE,DATE,DATETIME,MS," +
                    "ALICE_KCHI_DUR_SECS,ALICE_KCHI_COUNT," +
